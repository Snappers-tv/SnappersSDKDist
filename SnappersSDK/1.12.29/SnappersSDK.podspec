Pod::Spec.new do |s|
    ...
    # Vendored libraries embedded in xcframework (ABI/module compatibility with BUILD_LIBRARY_FOR_DISTRIBUTION):
    # EVReflection, SwiftKeychainWrapper, Kingfisher, SwipeCellKit, SwiftyGif,
