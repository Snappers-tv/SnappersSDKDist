Pod::Spec.new do |s|
    ...
    s.resources = 'Snappers.xcframework/**/Snappers.framework/**/*.{storyboardc,nib,strings,stringsdict,xcassets,plist,xcstrings,json,ttf,otf,png,jpg,jpeg,gif,svg,mp3,wav}'
