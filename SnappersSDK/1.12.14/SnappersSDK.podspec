Pod::Spec.new do |s|
    ...
    s.resource_bundles = {
        'SnappersSDKResources' => 'Snappers.xcframework/**/Snappers.framework/**/*.{storyboardc,nib,strings,stringsdict,xcassets,xcstrings,car,json,ttf,otf,png,jpg,jpeg,gif,svg,mp3,wav}'
    }
