Pod::Spec.new do |s|
    ...
    # Limit to device slice to avoid duplicate outputs from simulator + device resources
    s.resource_bundles = {
        'SnappersSDKResources' => 'Snappers.xcframework/ios-arm64/Snappers.framework/**/*.{storyboardc,nib,strings,stringsdict,xcassets,xcstrings,car,json,ttf,otf,png,jpg,jpeg,gif,svg,mp3,wav}'
    }
