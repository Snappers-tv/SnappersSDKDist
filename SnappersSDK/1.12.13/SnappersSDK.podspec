Pod::Spec.new do |s|
    ...
    # Avoid copying framework Info.plist into app bundle (would duplicate the app Info.plist)
    s.resources = 'Snappers.xcframework/**/Snappers.framework/**/*.{storyboardc,nib,strings,stringsdict,xcassets,xcstrings,car,bundle,json,ttf,otf,png,jpg,jpeg,gif,svg,mp3,wav}'
