Pod::Spec.new do |s|
 ...
 s.source           = { :http => "https://snappers-assets.s3.eu-central-1.amazonaws.com/SDK/IOS/#{s.version}/SnappersSDK.xcframework.zip" }
  ...
  # Zip root contains SnappersSDK.xcframework
  s.vendored_frameworks = 'SnappersSDK.xcframework'

  # Dependencies (keep aligned with your main app if needed)
  ...
  # Use the same HaishinKit line your SDK actually builds with
  # If your code expects legacy API, keep it pinned. Otherwise update accordingly.
  s.dependency 'HaishinKit', '~> 1.8.1'
